...
SELECT id, account_type, phone_number, email, name, photo, gender, aadhar_number, aadhar_photo_front, aadhar_photo_back, vehicle_type, age, gst_number, admin_role, created_at, updated_at FROM users ORDER BY created_at DESC LIMIT $1 OFFSET $2
`
